...
// Shared Forge Series hardware platform — identical wiring to ClockForge.
...
// External trigger input (IN1) — interrupt-driven only, not analog CV
#define CLK_IN_PIN A0 // GPIO26

// Pitch CV inputs (IN2, IN3) — the two signals being quantized
...
#define NUM_CV_INS 2   // Pitch CV inputs (IN1/CLK_IN_PIN is trigger only)
#define NUM_OUTPUTS 4  // All 4 outputs are DAC
#define NUM_CHANNELS 2 // Two independent quantizer channels
