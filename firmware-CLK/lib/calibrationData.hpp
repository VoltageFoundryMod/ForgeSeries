...
static const uint16_t CAL_LUT_MV[CAL_LUT_POINTS]  = {0, 500, 1000, 2000, 3000, 4000, 5000};
// DAC counts that produce those voltages (outputs trimmed to 5V at 4095).
static const uint16_t CAL_LUT_DAC[CAL_LUT_POINTS] = {0, 410, 819, 1638, 2457, 3276, 4095};
